...
public class ArcAlgorithmPane implements AlgorithmPane {

	private static final Logger log = LoggerFactory.getLogger(ArcAlgorithmPane.class);

	private Parent root;

	public static ArcAlgorithmPane Load() {
		FXMLLoader loader = App.injector.getInstance(FXMLLoader.class);
		Parent root = null;
		URL layoutResource = App.getLayoutResource("fxml/ArcAlgorithmPane.fxml");
		...
		ArcAlgorithmPane instance = loader.getController();
		instance.root = root;
		return instance;
	}
