  ...
  var menu = Menu.buildFromTemplate([
    ...
    },
    {
      ...
      submenu: [
        ...
        { type: "separator" },
        {
          label: "Базовые стратегии",
          click() {
            mainWindow.loadURL(
              url.format({
                pathname: path.join(
                  __dirname,
                  "src/main/mainStrategies/index.html"
                ),
                protocol: "file:",
                slashes: true
              })
        ...
        { type: "separator" },
        {
          ...
          click() {
            mainWindow.loadURL(
              url.format({
                pathname: path.join(__dirname, "src/main/arc/index.html"),
                protocol: "file:",
                slashes: true
              })
            );
        ...
        { type: "separator" },
        {
          ...
          click() {
            mainWindow.loadURL(
              url.format({
                pathname: path.join(__dirname, "src/main/car/index.html"),
                protocol: "file:",
                slashes: true
              })
            );
        ...
        },
        {
          ...
          click() {
            require("electron").shell.openExternal(
              "https://github.com/electron/electron/tree/v2.0.0/docs#readme"
            );
          }
        }
      ]
